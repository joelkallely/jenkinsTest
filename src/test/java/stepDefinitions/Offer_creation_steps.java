...
public class Offer_creation_steps extends Init 
{
	...
	{
		offerPageObjects.enterOfferName(Offer_name.toString());
		offerPageObjects.enterOfferDescription(Description.toString());
		offerPageObjects.clickOfferType();
		jswait.loadClick("//paper-item[contains(.,'"+Offer_type+"')]");
		offerPageObjects.clickOfferChannel();
		jswait.loadClick("//paper-item[contains(.,'"+Channel+"')]");
		offerPageObjects.clickOfferCategory();
		jswait.loadClick("//paper-item[contains(.,'"+Category+"')]");
